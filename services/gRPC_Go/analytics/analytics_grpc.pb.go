...
func (c *analyticsServiceClient) StreamPlayerAnalytics(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[LivePlayerUpdate, AnalysisResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AnalyticsService_ServiceDesc.Streams[0], AnalyticsService_StreamPlayerAnalytics_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[LivePlayerUpdate, AnalysisResponse]{ClientStream: stream}
	return x, nil
}
...
func _AnalyticsService_StreamPlayerAnalytics_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(AnalyticsServiceServer).StreamPlayerAnalytics(&grpc.GenericServerStream[LivePlayerUpdate, AnalysisResponse]{ServerStream: stream})
}
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _AnalyticsService_StreamPlayerAnalytics_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
